...
async function deleteItems() {
    const result = await categoryStore.deleteItems(props.items);
    ...
    >
        <div class="px-6.5 py-8 flex flex-col items-center">
            ...
            >
                <CustomButton
                    @click="close(false)"
                    :enable="categoryStore.deleteStatus !== 'loading'"
                    color="bg-slate-400"
                    :is-full="true"
                    padding="py-2.5 px-6"
                >
                ...
                <CustomButton
                    @click="deleteItems"
                    :loading="categoryStore.deleteStatus === 'loading'"
                    :loading-text="`${categoryStore.deleteProgress}/${props.items.length}`"
                    color="bg-danger"
                    :is-full="true"
                    padding="py-2.5 px-6"
                >
